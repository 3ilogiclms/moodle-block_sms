...
class sms_form extends moodleform {
    ...
    public function display_report() {
        ...
        $table->head  = array('S.No.', 'Name', 'Cell Number', 'Select');
...
class template_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('text', 'tname', 'Name:', array('size' => 50, 'maxlength' => 160));
    ...
    public function validation($data) {
        ...
        elseif($DB->record_exists('block_sms_template',array('tname' => $data['tname']))) {
    ...
    public function display_report() {
        global $DB, $OUTPUT, $CFG, $USER;
        $table = new html_table();
        $table->head  = array('S.No.', 'Name', 'Message Body', 'Edit', 'Delete');
